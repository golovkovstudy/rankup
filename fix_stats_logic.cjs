...
const targetStats = `        if (lowerId.includes('pushup') || lowerId.includes('dip')) newStats.pushupsTotal += 40;
...
const replaceStats = `        if (lowerId.includes('pushup') || lowerId.includes('dip') || lowerId.includes('plank')) newStats.pushupsTotal += 40;
